...
- [模块一：数通基础（01-13）](#模块一数通基础)
- [模块二：VRP 系统（14-19）](#模块二vrp-系统)
- [模块三：路由技术（20-26）](#模块三路由技术)
- [模块四：交换技术（27-32）](#模块四交换技术)
- [模块五：网络服务与 WAN（33-38）](#模块五网络服务与-wan)
- [模块六：WLAN 无线局域网（39-41）](#模块六wlan-无线局域网)
- [速查表与常见面试题](#速查表与常见面试题)
...
> 对应课程 00-13。从通信模型到应用层、传输层、网络层、链路层、物理层，逐层理解网络通信原理。
...
> 对应课程 14-19。VRP (Versatile Routing Platform) 是华为数据通信产品的通用操作系统。
...
> 对应课程 20-26。路由是网络层核心功能，包括静态路由、动态路由（OSPF）、路由汇总与认证。
...
> 对应课程 27-32。交换是局域网核心技术，包括 VLAN、STP、链路聚合、堆叠。
